...
hand_detection_videocam = cv2.CascadeClassifier(
    os.path.join(
...
class VideoCamera(object):
    ...
    def get_frame(self):
        ...
        hand_detected = hand_detection_videocam.detectMultiScale(
        ...
        try:
            ...
            if faces_detected == ():
                ...
                cv2.putText(
                    frame_flip, "Cool", (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA
                )
                ...
                cv2.putText(
                    frame_flip, "Hello", (0, 50), font, 2, (0, 0, 255), 3, cv2.LINE_AA
                )
